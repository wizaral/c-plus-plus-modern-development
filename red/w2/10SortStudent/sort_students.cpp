...
void TestComparison() {
    ...
    Student cpp_expert{"Petr", "Petrov", {{"c++", 9.5}, {"algorithms", 6.0}}, 7.75};
...
void TestSorting() {
    ...
    ASSERT(is_sorted(students.begin(), students.end(), [](const Student &first, const Student &second) { return first.Less(second); }));
}
